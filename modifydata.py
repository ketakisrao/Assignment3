...
for item in r:
    ...
    if(item[-1] == 'Asthma' or item[-1] == 'Issues Breathing' or item[-1] == 'Respiratory Condition'):
        ...
        new_group = 'Accident'
         ...
         or item[-1] == 'Mental or Behavioral' or item[-1] == 'Seizures' or item[-1] == 'Issues with Movement'):
        new_group = 'Congenital Anomalies'
    elif(item[-1] == 'Eye Condition' or item[-1] == 'Muscle/Bone Condition' or item[-1] == 'Skin Condition' or item[-1] == 'Kidney Condition'
         ...
         or item[-1] == 'Stomach or Bowel Issues' or item[-1] == 'Bladder Condition'):
        new_group = 'Organ Failure'
    elif(item[-1] == 'Other' or item[-1] == 'Unkown cause' or item[-1] == 'Natural Disaster'
         or item[-1] == 'Fire' or item[-1] == 'HIV/AIDS'):
         new_group = 'Other'
